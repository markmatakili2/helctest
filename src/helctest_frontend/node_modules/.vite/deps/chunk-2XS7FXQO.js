...
var require_value = __commonJS({
  "../../node_modules/simple-cbor/src/value.js"(exports) {
    ...
    function _serializeValue(major, minor, value2) {
      ...
      const bytes3 = [(major << 5) + minor].concat(value2.match(/../g).map((byte) => parseInt(byte, 16)));
    ...
    function tagged(tag, value2) {
      ...
      if (tag < 24) {
        ...
        const bytes3 = [(6 << 5) + minor].concat(value3.match(/../g).map((byte) => parseInt(byte, 16)));
        return new Uint8Array(bytes3).buffer;
      }
    }
...
@noble/curves/esm/bls12-381.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-2XS7FXQO.js.map
